...
My code is found in the file sylocoin.sol

blockchain token named SYC
...
create a new file called sylocoin.sol under the contracts folder in the remix ide explorer
